...
public class EmpleadoMongo {
    ...
    @BsonProperty("empleadoEstatus")
    private EstatusEmpleado empleadoEstatus;
    
    public EmpleadoMongo() {}

    public EmpleadoMongo(String idEmpleado, String nombre, String apellidoPaterno, String apellidoMaterno, String telefono, RolPuesto rolPuesto, LocalDate fechaNacimiento, EstatusEmpleado empleadoEstatus) {
