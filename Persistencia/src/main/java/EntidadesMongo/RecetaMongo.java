 ...
 */
@BsonDiscriminator
public class RecetaMongo {
    private String folio;
    private String cedulaMedico;
    private Integer usos;
    private EstadoReceta estado;
    private LocalDate fechaCaducidad;
    private List<DetalleRecetaMongo> detalles;
     ...
     */
    public RecetaMongo(String folio, String cedulaMedico, Integer usos, EstadoReceta estado, LocalDate fechaCaducidad, List<DetalleRecetaMongo> detalles) {
        this.folio = folio;
    ...
    public List<DetalleRecetaMongo> getDetalles() {
        return detalles;
    }

    /** @param detalles Los medicamentos a asignar a la receta. */
    public void setDetalles(List<DetalleRecetaMongo> detalles) {
        this.detalles = detalles;
    }
}
