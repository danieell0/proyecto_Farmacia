...
/**
 * Clase que representa una solicitud almacenada en MongoDB.
 *
 * Una solicitud Mongo almacena la información relacionada con el empleado que
...
public class SolicitudMongo {
    ...
    /**
     * Constructor por defecto de la clase SolicitudMongo.
     */
    public SolicitudMongo() {
    }

    /**
     * Constructor que inicializa todos los atributos de una solicitud Mongo.
     *
    ...
    /**
     * Devuelve una representación en cadena del objeto SolicitudMongo.
     *
