...
/**
 * Clase DTO que representa un movimiento dentro del sistema.
 *
...
public class MovimientoDTO {
    ...
    /**
     * Constructor por defecto de la clase MovimientoDTO.
     */
    public MovimientoDTO() {
    }

    /**
     * Constructor que inicializa todos los atributos de un movimiento DTO.
     *
     ...
     */
    public MovimientoDTO(String idMovimiento, LocalDateTime fechaHora, String idEmpleado, String codigoSolicitud) {
    ...
    /**
     * Devuelve una representación en cadena del objeto MovimientoDTO.
     *
